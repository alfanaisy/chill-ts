...
const Footer = () => {
  ...
  return (
    <div
      className={
        'bg-other-header w-full relative text-white flex flex-col items-center md:flex-row gap-4' +
        ' justify-around' +
    ...
    >
      <div className={'w-full'}>
        <img
          src={Logo}
          alt="App Logo"
          className={'w-20 md:w-40 object-cover mb-2'}
        />
        <p className={'text-text-light-200 text-xs font-normal md:text-base'}>
          @2023 Chill All Rights Reserved
        </p>
      </div>
      <div
        className={
          'w-full flex flex-col justify-between md:flex-row gap-y-4 gap-x-12'
        }
      >
